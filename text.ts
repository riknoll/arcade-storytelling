namespace story {
    ...
    //% help="github:arcade-storyprint-text.md"
    //% text.defl=":)"
    ...
    //% help="github:arcade-storysprite-say.md"
    //% text.defl=":)"
    ...
    //% help="github:arcade-storyprint-dialog.md"
    //% text.defl=":)"
    //% foreground.shadow=colorindexpicker
    //% foreground.defl=15
    //% background.shadow=colorindexpicker
    ...
    //% help="github:arcade-storyset-page-pause-length.md"
